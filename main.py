from tpg_ship_sim import forecaster, tpg_ship, storage_base, support_ship
import polars as pl
...
GS_data.write_csv("output_Folder/TPGshipdata/" + str(year) + "_sim_operation_data.csv")
stBASE_data.write_csv("output_Folder/storageBASEdata/" + str(year) + "storageBASE.csv")
spSHIP1_data.write_csv(
    "output_Folder/supportSHIPdata/" + str(year) + "supportSHIP1.csv"
)
spSHIP2_data.write_csv(
    "output_Folder/supportSHIPdata/" + str(year) + "supportSHIP2.csv"
)
